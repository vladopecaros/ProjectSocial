    ...
    public partial class Loading : System.Web.UI.Page
    {
        ...
        private void LoadScreen()
        {
            ...
            catch
            {
                ...
                SqlCommand creating = new SqlCommand("create table " + userid + "(Existing int, PostID uniqueidentifier, Bio varchar(300), Following uniqueidentifier, Follower uniqueidentifier, LikedPost uniqueidentifier);", Users);
